...
@javax.annotation.Generated(
    ...
    comments = "Source: sentinel/node/v1/msg.proto")
public final class MsgServiceGrpc {

  private MsgServiceGrpc() {}

  public static final String SERVICE_NAME = "sentinel.node.v1.MsgService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgRegisterRequest,
      sentinel.node.v1.Msg.MsgRegisterResponse> getMsgRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgRegister",
      requestType = sentinel.node.v1.Msg.MsgRegisterRequest.class,
      responseType = sentinel.node.v1.Msg.MsgRegisterResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgRegisterRequest,
      sentinel.node.v1.Msg.MsgRegisterResponse> getMsgRegisterMethod() {
    io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgRegisterRequest, sentinel.node.v1.Msg.MsgRegisterResponse> getMsgRegisterMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgRegisterMethod = MsgServiceGrpc.getMsgRegisterMethod) == null) {
          MsgServiceGrpc.getMsgRegisterMethod = getMsgRegisterMethod =
              io.grpc.MethodDescriptor.<sentinel.node.v1.Msg.MsgRegisterRequest, sentinel.node.v1.Msg.MsgRegisterResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgRegister"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgRegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgRegisterResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgUpdateRequest,
      sentinel.node.v1.Msg.MsgUpdateResponse> getMsgUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgUpdate",
      requestType = sentinel.node.v1.Msg.MsgUpdateRequest.class,
      responseType = sentinel.node.v1.Msg.MsgUpdateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgUpdateRequest,
      sentinel.node.v1.Msg.MsgUpdateResponse> getMsgUpdateMethod() {
    io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgUpdateRequest, sentinel.node.v1.Msg.MsgUpdateResponse> getMsgUpdateMethod;
    if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
          MsgServiceGrpc.getMsgUpdateMethod = getMsgUpdateMethod =
              io.grpc.MethodDescriptor.<sentinel.node.v1.Msg.MsgUpdateRequest, sentinel.node.v1.Msg.MsgUpdateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgUpdate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgUpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgUpdateResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgSetStatusRequest,
      sentinel.node.v1.Msg.MsgSetStatusResponse> getMsgSetStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgSetStatus",
      requestType = sentinel.node.v1.Msg.MsgSetStatusRequest.class,
      responseType = sentinel.node.v1.Msg.MsgSetStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgSetStatusRequest,
      sentinel.node.v1.Msg.MsgSetStatusResponse> getMsgSetStatusMethod() {
    io.grpc.MethodDescriptor<sentinel.node.v1.Msg.MsgSetStatusRequest, sentinel.node.v1.Msg.MsgSetStatusResponse> getMsgSetStatusMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgSetStatusMethod = MsgServiceGrpc.getMsgSetStatusMethod) == null) {
          MsgServiceGrpc.getMsgSetStatusMethod = getMsgSetStatusMethod =
              io.grpc.MethodDescriptor.<sentinel.node.v1.Msg.MsgSetStatusRequest, sentinel.node.v1.Msg.MsgSetStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgSetStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgSetStatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sentinel.node.v1.Msg.MsgSetStatusResponse.getDefaultInstance()))
  ...
  public static abstract class MsgServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void msgRegister(sentinel.node.v1.Msg.MsgRegisterRequest request,
        io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgRegisterResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgRegisterMethod(), responseObserver);
    }

    /**
     */
    public void msgUpdate(sentinel.node.v1.Msg.MsgUpdateRequest request,
        io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgUpdateResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgUpdateMethod(), responseObserver);
    }

    /**
     */
    public void msgSetStatus(sentinel.node.v1.Msg.MsgSetStatusRequest request,
        io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgSetStatusResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgSetStatusMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sentinel.node.v1.Msg.MsgRegisterRequest,
                sentinel.node.v1.Msg.MsgRegisterResponse>(
                  this, METHODID_MSG_REGISTER)))
          .addMethod(
            getMsgUpdateMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sentinel.node.v1.Msg.MsgUpdateRequest,
                sentinel.node.v1.Msg.MsgUpdateResponse>(
                  this, METHODID_MSG_UPDATE)))
          .addMethod(
            getMsgSetStatusMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sentinel.node.v1.Msg.MsgSetStatusRequest,
                sentinel.node.v1.Msg.MsgSetStatusResponse>(
  ...
  public static final class MsgServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MsgServiceBlockingStub> {
    ...
    /**
     */
    public sentinel.node.v1.Msg.MsgRegisterResponse msgRegister(sentinel.node.v1.Msg.MsgRegisterRequest request) {
    ...
    /**
     */
    public sentinel.node.v1.Msg.MsgUpdateResponse msgUpdate(sentinel.node.v1.Msg.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public sentinel.node.v1.Msg.MsgSetStatusResponse msgSetStatus(sentinel.node.v1.Msg.MsgSetStatusRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MsgServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sentinel.node.v1.Msg.MsgRegisterResponse> msgRegister(
        sentinel.node.v1.Msg.MsgRegisterRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sentinel.node.v1.Msg.MsgUpdateResponse> msgUpdate(
        sentinel.node.v1.Msg.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sentinel.node.v1.Msg.MsgSetStatusResponse> msgSetStatus(
        sentinel.node.v1.Msg.MsgSetStatusRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_MSG_SET_STATUS = 2;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MSG_REGISTER:
          serviceImpl.msgRegister((sentinel.node.v1.Msg.MsgRegisterRequest) request,
              (io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgRegisterResponse>) responseObserver);
          break;
        case METHODID_MSG_UPDATE:
          serviceImpl.msgUpdate((sentinel.node.v1.Msg.MsgUpdateRequest) request,
              (io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgUpdateResponse>) responseObserver);
          break;
        case METHODID_MSG_SET_STATUS:
          serviceImpl.msgSetStatus((sentinel.node.v1.Msg.MsgSetStatusRequest) request,
              (io.grpc.stub.StreamObserver<sentinel.node.v1.Msg.MsgSetStatusResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MsgServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sentinel.node.v1.Msg.getDescriptor();
    }
