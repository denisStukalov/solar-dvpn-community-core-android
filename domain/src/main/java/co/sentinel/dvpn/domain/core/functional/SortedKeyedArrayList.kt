 ...
 */
class SortedKeyedArrayList<K, E : Keyed<out K>>(private val comparator: Comparator<in K>) :
    KeyedArrayList<K, E>() {
    @Transient
    ...
    private class KeyList<K, E : Keyed<out K>>(private val list: SortedKeyedArrayList<K, E>) :
        AbstractList<K>(), Set<K> {
